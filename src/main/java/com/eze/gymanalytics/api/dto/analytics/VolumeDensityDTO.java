...
public class VolumeDensityDTO {
    private double currentDensity;
    private double previousDensity;
    private double changePercent;

    public VolumeDensityDTO() {}

    public VolumeDensityDTO(double currentDensity, double previousDensity, double changePercent) {
    ...
    public double getPreviousDensity() {
        return previousDensity;
    }

    public void setPreviousDensity(double previousDensity) {
        this.previousDensity = previousDensity;
    }
